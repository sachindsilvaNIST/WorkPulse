...
namespace WorkPulse.Api.Migrations
{
    ...
    [Migration("20260915053342_AddCustomSettlementPeriod")]
    partial class AddCustomSettlementPeriod
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkPulse.Api.Data.Entities.AttendanceMonthEntity", b =>
                {
                    ...
                    b.Property<DateOnly?>("CustomSettlementEnd")
                        .HasColumnType("date");

                    b.Property<DateOnly?>("CustomSettlementStart")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("WorkPulse.Api.Data.Entities.ShareEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("PublicPermission")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("ResourceType", "ResourceId", "OwnerUserId")
                        .IsUnique();

                    b.ToTable("Shares");
                });

            modelBuilder.Entity("WorkPulse.Api.Data.Entities.ShareGrantEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("WorkPulse.Api.Data.Entities.ShareEntity", b =>
                {
                    b.HasOne("WorkPulse.Api.Data.Entities.AppUser", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("WorkPulse.Api.Data.Entities.ShareGrantEntity", b =>
                {
                    b.HasOne("WorkPulse.Api.Data.Entities.ShareEntity", "Share")
                        .WithMany("Grants")
