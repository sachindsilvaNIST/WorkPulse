...
{
    public ReimbursementWindow()
    {
        InitializeComponent();
    }

    public ReimbursementWindow(ReimbursementViewModel viewModel) : this()
    {
    ...
    {
        if (DataContext is ReimbursementViewModel vm && sender is Button { Tag: TripDocumentWithTrip doc })
